...
/**
 * A simple Roman numeral class constructed for the purpose of demonstrating the
 * use of JUnit tests.
 *
 * @author Russ Moul
 */
public final class RomanNumeral {
    ...
    private static RomanEquiv[] romanMap = { new RomanEquiv(M_VALUE, "M"),
            new RomanEquiv(CM_VALUE, "CM"), new RomanEquiv(D_VALUE, "D"),
            new RomanEquiv(CD_VALUE, "CD"), new RomanEquiv(C_VALUE, "C"),
            new RomanEquiv(XC_VALUE, "XC"), new RomanEquiv(L_VALUE, "L"),
            new RomanEquiv(XL_VALUE, "XL"), new RomanEquiv(X_VALUE, "X"),
            new RomanEquiv(IX_VALUE, "IX"), new RomanEquiv(V_VALUE, "V"),
            new RomanEquiv(IV_VALUE, "IV"), new RomanEquiv(I_VALUE, "I") };
