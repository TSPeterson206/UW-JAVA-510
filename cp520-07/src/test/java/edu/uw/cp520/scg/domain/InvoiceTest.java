...
//        tc.addConsultantTime(conTime8);
    ...
    void getStartDateTest() {
        assertEquals("2020-11-01", invoice.getStartDate().toString());
    ...
    @Test
    void toStringTest() {
        String output = "this is the invoice toString. It contains the following properties: Microsoft, NOVEMBER, 2020-11-01, 32, 4800";
