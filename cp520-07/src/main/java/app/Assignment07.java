...
public class Assignment07 {
     ...
     * The month property.
     */
    private static Month month = edu.uw.ext.util.ListFactory.TEST_INVOICE_MONTH;

    /**
     * The year property.
     */
    private static int year = edu.uw.ext.util.ListFactory.TEST_INVOICE_YEAR;
    ...
    public static void main(String[] args)
        ...
        for (ClientAccount client : clientList) {
            invoices.add(dbs.getInvoice​(client, month, year));
        }
