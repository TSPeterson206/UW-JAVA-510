...
/**
 * The AddTimeCardCommand class for the project. It extends AbstractCommand.
 * 
...
public class AddTimeCardCommand extends AbstractCommand<TimeCard>
     ...
     * The target property.
     */
    private TimeCard target;

    /**
     * The contructor for the AddTimeCardCommand class.
     * 
