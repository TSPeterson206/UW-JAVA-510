...
public class ShapeDriver {
    ...
    private void geoRectangleEqualsCheck(GeoRectangle rectA, GeoShape rectB) {
    ...
    private void geoOvalEqualsCheck(GeoOval ovalA, GeoShape ovalB) {
    ...
    private void geoLineEqualsCheck(GeoLine lineA, GeoShape lineB) {
     ...
     */
    private void newOval(double xco, double yco, Color color, double wid,
        double hei) {
     ...
     * @param color the color of the oval
     */
    private void newRect(double xco, double yco, Color color, double wid,
        double hei) {
        GeoPoint origin = new GeoPoint(xco, yco);
     ...
     * @param color the color of the oval
     */
    private void newLine(double xco, double yco, Color color, double xco1,
        double yco1) {
        GeoPoint origin = new GeoPoint(xco, yco);
